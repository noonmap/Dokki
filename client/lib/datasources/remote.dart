...
import 'package:dokki/data/network/BaseApiServices.dart';
import 'package:dokki/data/network/NetworkApiService.dart';
...
class RemoteDataSource {
  ...
  Future<List<BookModel>> getSearchBookList(
      String search, int page, int size) async {
    try {
      dynamic response = await _apiServices.getGetApiResponse(
          "${BookApiUrl.search}?search=$search&page=$page&size=$size");
      return response;
    } catch (e) {
      rethrow;
    }
